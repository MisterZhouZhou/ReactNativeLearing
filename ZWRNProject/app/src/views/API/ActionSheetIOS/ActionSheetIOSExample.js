...
import {ActionSheetIOS,View,StyleSheet,Text,UIManager} from 'react-native';
...
var ActionSheetTintExample = React.createClass({
  ...
  render() {
    return (
      <View>
        <Text onPress={this.showActionSheet} style={style.button}>
          Click to show the Tint ActionSheet
        </Text>
        <Text>
          Clicked button: {this.state.clicked}
        </Text>
...
exports.examples = [
  ...
  {
    title: 'Show Tint Action Sheet',
    render(){ return(<ActionSheetTintExample />);}
  },
  {
  ...
  },
  {
    ...
    render(): ReactElement {
      return <ShareActionSheetExample url="./1f3ee.png" />;
    }
  },
  {
