...
import {StyleSheet, View, Text, Platform, SectionList} from 'react-native'
...
export default class ZWCityList extends Component{
  constructor(props) {
    super(props);
    this.state = {
        data: [],
  ...
  _onSectionselect = (section, index) => {
      //跳转到某一项
     this.refs.listView.scrollToIndex({animated: true, index: this.state.sectionSize[index]})
 }
